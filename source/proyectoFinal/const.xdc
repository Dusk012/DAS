...
##
##  Prop車sito:
##    Configuraci車n completa para el proyecto lab4_piano_vga_fullscreen
##    (Basada en la placa Basys 3 / FPGA Artix-7)
##
#####################################################################

#
# Voltaje del interfaz de configuraci車n de la FPGA
#
...
# Nota: La placa Basys 3 no tiene altavoz integrado.
# Este pin (A14) corresponde al PIN 1 del puerto PMOD JA.
# Conecta ah赤 tu zumbador (buzzer) o m車dulo de audio.
#
set_property -dict { PACKAGE_PIN K17 IOSTANDARD LVCMOS33 } [get_ports speaker]

#
# Pines conectados a la VGA (12 bits)
#
