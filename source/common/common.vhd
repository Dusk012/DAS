...
package common is
  ...
  -- Sincronizador de entrada binaria
  ...
  component debouncer
    ...
    port (
      ...
      xDeb : out std_logic    -- salida que sigue a la entrada pero sin rebotes
    );
  end component;
